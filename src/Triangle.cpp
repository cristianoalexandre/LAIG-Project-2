...
void Triangle::setLeftX(float x){this->left.x = x;}
void Triangle::setLeftY(float y){this->left.y = y;}
void Triangle::setLeftZ(float z){this->left.z = z;}

void Triangle::setRightX(float x){this->right.x = x;}
void Triangle::setRightY(float y){this->right.y = y;}
void Triangle::setRightZ(float z){this->right.z = z;}

void Triangle::setTopX(float x){this->top.x = x;}
void Triangle::setTopY(float y){this->top.y = y;}
void Triangle::setTopZ(float z){this->top.z = z;}
